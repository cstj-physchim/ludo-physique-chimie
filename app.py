...
from io import BytesIOimport re
import base64
import json
import random
import textwrap
        ...
        .home-wave.wave-top-left {
            ...
            background:
                radial-gradient(circle at 76% 78%,
                    rgba(63, 224, 216, .98) 0%,
                    rgba(42, 214, 205, .96) 18%,
                    rgba(72, 219, 171, .90) 36%,
                    rgba(126, 225, 126, .78) 52%,
                    rgba(176, 230, 85, .60) 66%,
                    rgba(186, 231, 81, .32) 78%,
                    rgba(186, 231, 81, .08) 90%,
                    rgba(186, 231, 81, 0) 100%);
            box-shadow:
        ...
        .home-wave.wave-bottom-right {
            ...
            background:
                radial-gradient(circle at 24% 22%,
                    rgba(113, 95, 255, .98) 0%,
                    rgba(125, 79, 248, .96) 20%,
                    rgba(148, 63, 235, .90) 38%,
                    rgba(180, 47, 219, .80) 56%,
                    rgba(207, 41, 200, .62) 70%,
                    rgba(229, 51, 188, .34) 82%,
                    rgba(235, 62, 191, .10) 92%,
                    rgba(235, 62, 191, 0) 100%);
            box-shadow:
